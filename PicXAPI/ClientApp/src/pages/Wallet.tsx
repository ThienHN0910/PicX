...
const Wallet = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto py-10 px-4">
            ...
            <p className="text-lg mb-4">Current balance: <span className="font-semibold text-green-600">{balance.toFixed(0)} VND</span></p>
                        ...
                        {requests.map((req) => (
                            <li key={req.requestId} className="border p-3 rounded-lg">
                                <div className="flex justify-between">
                                    <span>Amount: {req.amountRequested} VND</span>
