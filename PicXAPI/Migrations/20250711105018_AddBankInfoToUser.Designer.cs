...
namespace PicXAPI.Migrations
{
    ...
    [Migration("20250711105018_AddBankInfoToUser")]
    partial class AddBankInfoToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PicXAPI.Models.ArtistProfile", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Chat", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.CommentReply", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Favorite", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.FinancialReport", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Products", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PicXAPI.Models.Reporting", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.Session", b =>
                {
            ...
            modelBuilder.Entity("PicXAPI.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PicXAPI.Models.Wallet", b =>
                {
                    ...
                    b.HasKey("WalletId")
                        .HasName("PK__Wallets__0EE6F0414E6896D2");
            ...
            modelBuilder.Entity("PicXAPI.Models.WalletTransaction", b =>
                {
                    ...
                    b.HasKey("TransactionId")
                        .HasName("PK__WalletTr__85C600AF64BBD695");
            ...
            modelBuilder.Entity("PicXAPI.Models.WithdrawRequest", b =>
                {
                    ...
                    b.HasKey("RequestId")
                        .HasName("PK__Withdraw__18D3B90F1E0D8D75");
            ...
            modelBuilder.Entity("PicXAPI.Models.ArtistProfile", b =>
                {
                    b.HasOne("PicXAPI.Models.User", "Artist")
                        .WithOne("ArtistProfile")
                        .HasForeignKey("PicXAPI.Models.ArtistProfile", "ArtistId")
            ...
            modelBuilder.Entity("PicXAPI.Models.Cart", b =>
                {
                    b.HasOne("PicXAPI.Models.Products", "Product")
                        .WithMany("Carts")
                    ...
                    b.HasOne("PicXAPI.Models.User", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("PicXAPI.Models.Category", b =>
                {
                    b.HasOne("PicXAPI.Models.Category", "ParentCategory")
            ...
            modelBuilder.Entity("PicXAPI.Models.CommentReply", b =>
                {
                    b.HasOne("PicXAPI.Models.Comment", "Comment")
            ...
            modelBuilder.Entity("PicXAPI.Models.Order", b =>
                {
                    b.HasOne("PicXAPI.Models.User", "Buyer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("PicXAPI.Models.OrderDetail", b =>
                {
                    b.HasOne("PicXAPI.Models.Order", "Order")
            ...
            modelBuilder.Entity("PicXAPI.Models.Products", b =>
                {
                    ...
                    b.HasOne("PicXAPI.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("PicXAPI.Models.Wallet", b =>
                {
                    b.HasOne("PicXAPI.Models.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("PicXAPI.Models.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PicXAPI.Models.WalletTransaction", b =>
                {
                    b.HasOne("PicXAPI.Models.Wallet", "Wallet")
